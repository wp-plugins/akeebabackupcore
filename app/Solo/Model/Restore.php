...
class Restore extends Model
{
	...
	function validateRequest()
	{
		...
		if (!$exists)
		{
			throw new \RuntimeException(Text::_('RESTORE_ERROR_ARCHIVE_MISSING'), 500);
		}
		...
		{
			throw new \RuntimeException(Text::_('RESTORE_ERROR_INVALID_TYPE'), 500);
		}
...
ENDDATA;
	...
	{
		$options = array();
		$options[] = Select::option('hybrid',	Text::_('RESTORE_LABEL_EXTRACTIONMETHOD_HYBRID'));
		$options[] = Select::option('direct',	Text::_('RESTORE_LABEL_EXTRACTIONMETHOD_DIRECT'));
		$options[] = Select::option('ftp',		Text::_('RESTORE_LABEL_EXTRACTIONMETHOD_FTP'));
