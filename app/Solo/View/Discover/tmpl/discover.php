...
<form name="adminForm" id="adminForm" action="<?php echo $router->route('index.php?view=discover&task=' . $task) ?>" method="POST" class="form-horizontal" role="form">
	...
	<div class="well form-inline">
		<label for="directory2"><?php echo Text::_('DISCOVER_LABEL_DIRECTORY') ?></label>
	...
	<div class="form-group">
		<label class="control-label col-sm-3" for="input01">
			<?php echo Text::_('DISCOVER_LABEL_FILES'); ?>
		</label>
		<div class="col-sm-9">
			...
			<p class="help-block"><?php echo Text::_('DISCOVER_LABEL_SELECTFILES'); ?></p>
		</div>
	</div>
	...
	<div class="col-sm-9 col-sm-push-3">
		<button class="btn btn-lg btn-primary" onclick="this.form.submit(); return false;">
			...
			<?php echo Text::_('DISCOVER_LABEL_IMPORT') ?>
		</button>
	</div>
	
	<?php else: ?>
	<p>
		<?php echo Text::_('DISCOVER_ERROR_NOFILES'); ?>
	</p>
	<p>
		<button onclick="this.form.submit(); return false;" class="btn btn-default"><?php echo Text::_('DISCOVER_LABEL_GOBACK') ?></button>
	</p>
	<?php endif; ?>	
</form>