...
class AliceCoreDomainChecksRuntimeerrorsWincantappend extends AliceCoreDomainChecksAbstract
{
    ...
    {
        parent::__construct(30, Text::_('ALICE_ANALYZE_RUNTIME_ERRORS_WINCANTAPPEND'), $logFile);
    }
	...
	public function check()
	{
        ...
        if($error)
        {
            ...
            $this->setResult(-1);
            throw new Exception(Text::_('ALICE_ANALYZE_RUNTIME_ERRORS_WINCANTAPPEND_ERROR'));
        }
	...
	{
		return Text::_('ALICE_ANALYZE_RUNTIME_ERRORS_WINCANTAPPEND_SOLUTION');
	}
