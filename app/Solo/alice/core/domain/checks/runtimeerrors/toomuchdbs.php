...
class AliceCoreDomainChecksRuntimeerrorsToomuchdbs extends AliceCoreDomainChecksAbstract
{
    ...
    {
        parent::__construct(40, Text::_('ALICE_ANALYZE_RUNTIME_ERRORS_TOOMUCHDBS'), $logFile);
    }
	...
	public function check()
	{
		...
		if(count($ex_tables))
		{
			...
			throw new Exception(Text::_('ALICE_ANALYZE_RUNTIME_ERRORS_TOOMUCHDBS_ERROR'));
		}
	...
	{
		return Text::_('ALICE_ANALYZE_RUNTIME_ERRORS_TOOMUCHDBS_SOLUTION');
	}
}
