...
class AliceCoreDomainChecksRequirementsDbpermissions extends AliceCoreDomainChecksAbstract
{
    ...
    {
        parent::__construct(40, Text::_('ALICE_ANALYZE_REQUIREMENTS_DBPERMISSIONS'), $logFile);
    }
	...
	public function check()
	{
		...
		try{
			...
			$this->setResult(-1);
			throw new Exception(Text::_('ALICE_ANALYZE_REQUIREMENTS_DBPERMISSIONS_ERROR'));
		}
	...
	{
		return Text::_('ALICE_ANALYZE_REQUIREMENTS_DBPERMISSIONS_SOLUTION');
	}
}
