...
abstract class Query
{
	 ...
	 *
	 * @throws  \RuntimeException  When the database object is invalid
	 */
	public function dateFormat()
	{
		if (!($this->db instanceof \Awf\Database\Driver))
		{
	...
	{
		return '<pre class="Query">' . str_replace('#__', $this->db->getPrefix(), $this) . '</pre>';
	}
	 ...
	 *
	 * Note that 'q' is an alias for this method as it is in \Awf\Database\Driver.
	 *
	 * Usage:
	 ...
	 *
	 * Note that 'qn' is an alias for this method as it is in \Awf\Database\Driver.
	 *
	 * Usage:
	 * $query->quoteName('#__a');
	 * $query->qn('#__a');
