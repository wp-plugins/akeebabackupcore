...
abstract class Select
{
	 ...
	 */
	public static function genericList($data, $name, $attribs = null, $optKey = 'value', $optText = 'text',
									 ...
									 $translate = false)
	{
		...
		foreach ($data as $obj)
		{
			...
			$html .= "\n\t" . '<label' . $class . '>';
			$html .= "\n\t\n\t" . '<input type="' . $radioType . '" name="' . $name . '" id="' . $id . '" value="' . $k . '" ' . $extra
				. $attribs . ' >' . $t;
			$html .= "\n\t" . '</label>';
