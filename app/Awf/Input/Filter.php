 ...
 * Class Filter
 *
 * Filters the input variables to prevent abuse
 *
 * @package Awf\Input
 */
class Filter
{
	/**
	 * @var    array  A container for \Awf\Input\Filter instances.
	 */
	 ...
	 * @param   integer  $xssAuto     Only auto clean essentials = 0, Allow clean blacklisted tags/attr = 1
	 *
	 * @return  \Awf\Input\Filter  The \Awf\Input\Filter object.
	 */
	public static function &getInstance($tagsArray = array(), $attrArray = array(), $tagsMethod = 0, $attrMethod = 0, $xssAuto = 1)
	{
		...
		{
			self::$instances[$sig] = new \Awf\Input\Filter($tagsArray, $attrArray, $tagsMethod, $attrMethod, $xssAuto);
		}
