...
{
	echo sprintf('Akeeba Backup for WordPress requires PHP 5.3.4 or later but your server only has PHP %s.', PHP_VERSION);
}
...
try
{
	...
	$hasPro = AKEEBA_PRO ? true : !empty($downloadId);
	unset($downloadId);
	if ($hasPro)
	{
